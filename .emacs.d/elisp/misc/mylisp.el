...
;;;
;;; ange-ftp のフロントエンド dir-ftp の定義
;;; 

;;; dir-ftp の各種オプションの仮定義
...
(defun dir-ftp ()
  ...
  (interactive)
  (dired (concat "/" 
				 ;; method が none ならメソットは指定せず /dir-ftp-user@... にて ange-ftp に
				 ;; method を自動判別させ，そうでなければ /dir-ftp-method:dir-ftp-user@... と
				 ;; 明示的に method を指定
...
;;; Mac の場合は ls のオプションが限定されるので emacs 内蔵の ls を使用
